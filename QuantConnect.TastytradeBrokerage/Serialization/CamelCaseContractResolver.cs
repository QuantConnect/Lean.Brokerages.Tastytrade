...
/// a <see cref="CamelCaseNamingStrategy"/> to JSON property names.
/// </summary>
public sealed class CamelCaseContractResolver : DefaultContractResolver
{
    /// <summary>
    /// Gets the singleton instance of the <see cref="CamelCaseContractResolver"/>.
    /// </summary>
    ...
    /// with a <see cref="CamelCaseNamingStrategy"/>.
    /// </summary>
    private CamelCaseContractResolver()
    {
