...
/// <summary>
/// Represents a market order, which executes immediately at the current market price.
/// </summary>
public class MarketOrderRequest : OrderBaseRequest
{
    /// <summary>
    /// Gets the order type (Market).
    /// </summary>
    public override OrderType OrderType => OrderType.Market;

    /// <summary>
    /// Initializes a new instance of a <see cref="MarketOrderRequest"/>.
    /// </summary>
